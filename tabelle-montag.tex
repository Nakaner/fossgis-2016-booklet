...
\section*{Vorträge am Montag}\label{mittwoch}
...
\ifthispageodd{\ThisCenterWallPaper{1.0}{montag-ungerade}}{\ThisCenterWallPaper{1.0}{montag-gerade}}
	\begin{longtabu}{lZ{2.93cm}Z{2.93cm}}
		...
		\endhead
		15:00
		\talk{GIS in der Cloud - Schönwetterwolke, Gewitter oder reiner Dunst?}{Till Adams}
		\talk{OpenStreetMap und Wikidata}{Michael Maier}
		\coffeespace\tabularnewline
		15:30
		\talk{Freie (Geo-)Daten mit Freier (Geo-)Software - oder: wie kommen Geodaten zum Nutzer?}{Markus Neteler}
		\talk{Die Karte verändert sich - der Standardstil openstreetmap-carto}{Michael Glanznig}
		\coffeespace\tabularnewline
		16:00
		\talk{Schadstoffeinleitungen in Kanäle und Gewässer verfolgen}{Gerhard Genuit}
		\talk{SciGRID: ein offenes Referenzmodell europäischer Übertragungsnetze für wissenschaftliche Untersuchungen}{Wided Medjroubi}
		\coffeespace\tabularnewline
		\rowcolor{commongray}
		16:30 & \multicolumn{2}{c}{%
			...
			Kaffeepause} \tabularnewline
		17:00
		\talk{Neues in Metador 2.1}{Axel Schaefer}
		\talk{Automatische Edits und Importe in OpenStreetMap}{Frederik Ramm}
		\coffeespace\tabularnewline
		17:30
		\talk{Neue Funktionen in QGIS 2.10 - 2.16}{Marco Hugentobler}
		\talk{Braucht OpenStreetMap Flächen und Kanten?}{Roland Olbricht}
		\coffeespace\tabularnewline
		18:00
		\talk{Neues von MapProxy}{Oliver Tonnhofer}
