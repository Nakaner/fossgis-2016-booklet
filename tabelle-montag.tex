...
\section*{Workshops am Montag}\label{montag-workshops}%a
	...
	\noindent\workshop{Einführungsworkshop \mbox{OpenLayers 3}}{Marc Jansen}{3004}\workshopspace
% 	
\newpage
\section*{Workshops am Dienstagvormittag}\label{dienstag-workshops}
	...
	\noindent\workshop{Einführung in die Geodaten\-verarbeitung mit Python}{Christian Strobl}{3004}\workshopspace

\newpage
\section*{Workshops am Dienstagnachmittag}
	\newsmalltimeslot{13:30 bis 15:00}
	\noindent\workshop{MapFish Print 3 -- Maps, \mbox{Templates} und Reports}{Tobias Sauerwein}{432}\workshopspace
...
\section*{Workshops am Mittwoch}\label{mittwoch-workshops}
	\newsmalltimeslot{09:00 bis 10:30}
	\noindent\workshop{Grafische Prozessmodellierung in QGIS}{Claas Leiner}{432}\workshopspace
...
\ThisCenterWallPaper{1.0}{montag-gerade}
...
% \enlargethispage{15\baselineskip}
	\noindent\begin{tabular}{lZ{2.93cm}Z{2.93cm}}
		...
		\tabularnewline
		13:30
		\talk{Jenseits von \mbox{Mercator}}{Christoph Hormann}
		\talk{}{}
		\coffeespace\tabularnewline
		14:00
		\talk{GIS Lightning Talks}{}
		\talk{}{}
		\coffeespace\tabularnewline
		\rowcolor{commongray}
...
\ThisCenterWallPaper{1.0}{montag-ungerade}
	...
	\enlargethispage{5\baselineskip}
		...
		\talk{Braucht OSM \mbox{Flächen} und \mbox{Kanten?}}{Roland Olbricht}
		\coffeespace\tabularnewline
		18:00
